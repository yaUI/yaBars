...
["MicroMenu"] = {
	...
	position = {a="BOTTOMRIGHT", x=-20, y=20},  	-- if not locked
	},

["ExitVehicleButton"] = {
	disable = false,				user_placed = false,	-- if user_placed is set to false exit vehicle button will be 'docked' into bar1
	position = {a="BOTTOM", x=-120, y=238}, 			-- only if user_placed = true
	button_size = 28,									-- only if user_placed = true
	},
["ExtraButton"] = {
	disable = false,
	position = {a="TOP", x=0, y=-205},
	},
